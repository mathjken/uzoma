...
namespace Uzoma.Api.Data
{
    public static class DbInitializer
    {
        public static void Initialize(UzomaDbContext context)
        {
            ...
            // 1. Ensure Categories exist first (otherwise Products with these IDs won't show up)
            ...
            // 2. Only seed products if the table is empty
            ...
            var products = new List<Product>
            {
                ...
                // Formal (CategoryId 6)
                new() { Name = "Tailored Formal Suit", Price = 480, CategoryId = 6, ImageUrl = "https://images.unsplash.com/photo-1598808503744-3ede93aa26c9", CreatedAt = seedDate, Description = "Premium Italian wool." },
